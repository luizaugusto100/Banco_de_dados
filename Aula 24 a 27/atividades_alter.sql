...
alter table turmas modify column turno enum ('manhã','tarde','noite');
...
alter table reversas_sala modify column id_reserva int;
alter table reversas_sala modify column id_turma int primary key;
alter table reservas_sala modify column data_reserva date, drop column observacao;
alter table reserva_sala modify column data_reserva date, modify column hora_inicio time;